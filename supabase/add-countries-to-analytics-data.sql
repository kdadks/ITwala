-- Add countries column to analytics_data table if it doesn't exist
DO $$
BEGIN
    IF NOT EXISTS (
...
SELECT 'Analytics aggregation function updated with country tracking!' as result;
