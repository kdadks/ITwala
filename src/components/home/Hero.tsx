    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-600 text-white">
      ...
      <div className="container mx-auto px-4 py-16 md:py-28 relative z-10">
        <div className="max-w-5xl mx-auto text-center mb-8 md:mb-12">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 md:mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-primary-100 px-2">
              Transform Your Future with IT Excellence
            </h1>
            <p className="text-base sm:text-lg md:text-xl font-semibold text-primary-200 mb-2">
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 text-sm md:text-base px-4"
          >
