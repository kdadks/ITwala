          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-12 lg:pt-32 lg:pb-14">
            ...
            >
              <div className="flex items-center gap-3 mb-7">
                ...
                <span className="text-[11px] font-semibold tracking-[0.2em] uppercase text-primary-500">AI Learning · Free Guides &amp; Courses</span>
              </div>
              ...
              <p className="text-[0.97rem] text-gray-500 leading-[1.85] max-w-[540px] mb-8">
                Comprehensive collection of AI and machine learning resources to accelerate your learning journey — from beginner guides to advanced courses.
              </p>
              <div className="flex flex-wrap gap-2">
                {['Free Guides', 'Expert Courses', 'Career Support', 'Industry Insights'].map((tag) => (
                  <span key={tag} className="px-3 py-1 bg-primary-50 text-primary-600 rounded-full text-[12px] font-medium border border-primary-100">{tag}</span>
                ))}
              </div>
            </motion.div>
          </div>
