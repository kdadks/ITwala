...
import { FaBrain, FaArrowLeft, FaCheckCircle, FaRocket } from 'react-icons/fa';
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <p className="text-[1.05rem] text-gray-600 font-medium leading-snug">
                  ...
                  <span className="text-gray-400 font-normal"> · automate processes &amp; drive intelligent decisions</span>
                </p>
              </div>
