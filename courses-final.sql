...
-- Note: Admin policies require a profiles table with role column
-- If you don't have this table yet, you can comment out these admin policies
-- and just use the public read policy above
